    ...
    handleChange(e){
        if(e.target.name=== "file"){
            ...
            console.log('files' + this.state.file);
              ...
              UpdateProfile = {...UpdateProfile, [e.target.name]: e.target.value};
                this.setState({ UpdateProfile });
                console.log('change fired', this.state);
            //this.setState({UpdateProfile: {[e.target.name] : e.target.value}});
          }
    }
    ...
    render(){
        ...
        const ActiveElections = () => {
            if(!this.state.Elections){
                ...
                return <Pie data={this.state.chartData} options={this.state.chartOptions}></Pie>
            }
        }
                    ...
                    <Card className="shadow mt">
                        ...
                        <CardBody>
                            <CardTitle>
                                ...
                                <UpdateForm profile={this.state.UpdateProfile}></UpdateForm>
                        </CardBody>
                    </Card>
                </Col>
            </Row></Container>}/>
