                            ...
                            <CardBody>
                                ...
                                <CardText className="shadow mt br-20">
                                    <ListGroup>
                                        ...
                                        <ListGroupItem className="d-flex justify-content-between"><span className="d-flex justify-content-between">Institution: </span> <Badge >{feed.institution}</Badge></ListGroupItem>
                                    </ListGroup></CardText>
                            </CardBody>
